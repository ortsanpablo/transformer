...
def run(total_epoch, best_loss):
    ...
    for step in range(total_epoch):
        ...
        if valid_loss < best_loss:
            ...
            torch.save(model.state_dict(), 'ATTENTION/saved/lowres3ATTmodel-{0}.pt'.format(valid_loss))

        f = open('ATTENTION/result/lowres3train_loss.txt', 'w')
        f.write(str(train_losses))
        f.close()

        f = open('ATTENTION/result/lowres3bleu.txt', 'w')
        f.write(str(bleus))
        f.close()

        f = open('ATTENTION/result/lowres3test_loss.txt', 'w')
    ...
    f = open('ATTENTION/result/lowres3timememory.txt', 'w')
